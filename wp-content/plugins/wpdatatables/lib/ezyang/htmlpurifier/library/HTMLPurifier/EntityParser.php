...
class HTMLPurifier_EntityParser
{
    ...
    {
        return \preg_replace_callback($this->_textEntitiesRegex, array($this, 'entityCallback'), $string);
    }
    /**
     * Substitute entities with the parsed equivalents.  Use this on
    ...
    {
        return \preg_replace_callback($this->_attrEntitiesRegex, array($this, 'entityCallback'), $string);
    }
    /**
    ...
    protected function entityCallback($matches)
    {
        ...
        if ($hex_part !== NULL && $hex_part !== "") {
            ...
            if (isset($this->_entity_lookup->table[$named_part])) {
                ...
                if (!empty($matches[3])) {
                    return \preg_replace_callback($this->_semiOptionalPrefixRegex, array($this, 'entityCallback'), $entity);
                }
                return $entity;
            }
        }
    ...
    public function substituteNonSpecialEntities($string)
    {
        ...
        return \preg_replace_callback($this->_substituteEntitiesRegex, array($this, 'nonSpecialEntityCallback'), $string);
    }
    /**
     * Callback function for substituteNonSpecialEntities() that does the work.
     *
    ...
    {
        return \preg_replace_callback($this->_substituteEntitiesRegex, array($this, 'specialEntityCallback'), $string);
    }
    /**
