...
namespace WPDT\MyCLabs\Enum\PHPUnit;

use WPDT\MyCLabs\Enum\Enum;
use WPDT\SebastianBergmann\Comparator\ComparisonFailure;
/**
 ...
 */
final class Comparator extends \WPDT\SebastianBergmann\Comparator\Comparator
{
