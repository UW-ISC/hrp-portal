...
class ArrayArgumentProcessor
{
    ...
    public static function processArguments(ArrayArgumentHelper $arrayArgumentHelper, callable $method, ...$arguments) : array
    {
        ...
        if ($matrixPair !== []) {
            if (self::$arrayArgumentHelper->isVector($matrixPair[0]) === \true && self::$arrayArgumentHelper->isVector($matrixPair[1]) === \false || self::$arrayArgumentHelper->isVector($matrixPair[0]) === \false && self::$arrayArgumentHelper->isVector($matrixPair[1]) === \true) {
