...
class Week
{
    ...
    public static function number($dateValue, $method = Constants::STARTWEEK_SUNDAY)
    {
        ...
        Helpers::silly1900($PHPDateObject, '+ 5 years');
    ...
    private static function buggyWeekNum1904(int $method, bool $origNull, DateTime $dateObject) : bool
    {
        ...
        return $method === Constants::DOW_SUNDAY && SharedDateHelper::getExcelCalendar() === SharedDateHelper::CALENDAR_MAC_1904 && !$origNull && $dateObject->format('Y-m-d') === '1904-01-01';
    }
}
