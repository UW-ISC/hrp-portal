...
{
    public const LEADING_SYMBOL = \true;
    public const TRAILING_SYMBOL = \false;
    public const SYMBOL_WITH_SPACING = \true;
     ...
     */
    public function __construct(string $currencyCode = '$', int $decimals = 2, bool $thousandsSeparator = \true, bool $currencySymbolPosition = self::LEADING_SYMBOL, bool $currencySymbolSpacing = self::SYMBOL_WITHOUT_SPACING, ?string $locale = null)
    {
