...
class CellReferenceHelper
{
    ...
    {
        return $this->beforeCellAddress !== $beforeCellAddress || $this->numberOfColumns !== $numberOfColumns || $this->numberOfRows !== $numberOfRows;
    }
    ...
    public function cellAddressInDeleteRange(string $cellAddress) : bool
    {
        ...
        if ($this->numberOfRows < 0 && $cellRow >= $this->beforeRow + $this->numberOfRows && $cellRow < $this->beforeRow) {
            return \true;
        } elseif ($this->numberOfColumns < 0 && $cellColumnIndex >= $this->beforeColumn + $this->numberOfColumns && $cellColumnIndex < $this->beforeColumn) {
            return \true;
        }
        return \false;
    }
