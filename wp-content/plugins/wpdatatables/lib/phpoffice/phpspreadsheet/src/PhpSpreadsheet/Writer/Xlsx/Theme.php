...
use WPDT\PhpOffice\PhpSpreadsheet\Theme as SpreadsheetTheme;
class Theme extends WriterPart
{
    ...
    public function writeTheme(Spreadsheet $spreadsheet)
    {
        ...
        $this->writeFonts($objWriter, $theme->getMajorFontLatin(), $theme->getMajorFontEastAsian(), $theme->getMajorFontComplexScript(), $theme->getMajorFontSubstitutions());
        $objWriter->endElement();
        // a:majorFont
        // a:minorFont
        $objWriter->startElement('a:minorFont');
        $this->writeFonts($objWriter, $theme->getMinorFontLatin(), $theme->getMinorFontEastAsian(), $theme->getMinorFontComplexScript(), $theme->getMinorFontSubstitutions());
        $objWriter->endElement();
        // a:minorFont
        $objWriter->endElement();
        // a:fontScheme
