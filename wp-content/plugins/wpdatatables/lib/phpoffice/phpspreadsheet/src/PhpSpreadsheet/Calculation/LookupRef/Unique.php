...
class Unique
{
    ...
    public static function unique($lookupVector, $byColumn = \false, $exactlyOnce = \false)
    {
        ...
        return $byColumn === \true ? self::uniqueByColumn($lookupVector, $exactlyOnce) : self::uniqueByRow($lookupVector, $exactlyOnce);
    }
    /**
     * @return mixed
     */
    private static function uniqueByRow(array $lookupVector, bool $exactlyOnce)
    {
        ...
        \array_walk($lookupVector, function (array &$value) : void {
            $value = \implode(\chr(0x0), $value);
        });
    ...
    {
        $caseInsensitiveCounts = \array_count_values(\array_map(function (string $value) {
