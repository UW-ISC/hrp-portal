...
use WPDT\PhpOffice\PhpSpreadsheet\HashTable;
...
use WPDT\PhpOffice\PhpSpreadsheet\Worksheet\Drawing as WorksheetDrawing;
...
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Chart;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Comments;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\ContentTypes;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\DocProps;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Drawing;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Rels;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\RelsRibbon;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\RelsVBA;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\StringTable;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Style;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Table;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Theme;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Workbook;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xlsx\Worksheet;
use ZipArchive;
...
class Xlsx extends BaseWriter
{
    ...
    public function save($filename, int $flags = 0) : void
    {
        ...
        if ($this->spreadSheet->hasMacros()) {
            ...
            if ($macrosCode !== null) {
                // we have the code ?
                $zipContent['xl/vbaProject.bin'] = $macrosCode;
        ...
        for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
            if ($this->getDrawingHashTable()->getByIndex($i) instanceof WorksheetDrawing) {
                ...
                \call_user_func($callable, $this->getDrawingHashTable()->getByIndex($i)->getImageResource());
