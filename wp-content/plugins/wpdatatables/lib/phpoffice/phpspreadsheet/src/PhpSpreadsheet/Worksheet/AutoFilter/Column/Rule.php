...
namespace WPDT\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column;
...
class Rule
{
    ...
    {
        $this->setEvaluatedFalse();
        if ($grouping !== null && !\in_array($grouping, self::DATE_TIME_GROUPS) && !\in_array($grouping, self::DYNAMIC_TYPES) && !\in_array($grouping, self::TOP_TEN_TYPE)) {
