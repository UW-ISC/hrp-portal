...
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\OLE;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File;
use WPDT\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\Root;
...
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet;
class Xls extends BaseWriter
{
    ...
    private function buildWorksheetEschers() : void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \WPDT\PhpOffice\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
    ...
    private function writeSummaryInformation()
    {
        ...
        $this->writeSummaryProp($props->getTitle(), $dataSection_NumProps, $dataSection, 0x2, 0x1e);
        $this->writeSummaryProp($props->getSubject(), $dataSection_NumProps, $dataSection, 0x3, 0x1e);
        $this->writeSummaryProp($props->getCreator(), $dataSection_NumProps, $dataSection, 0x4, 0x1e);
        $this->writeSummaryProp($props->getKeywords(), $dataSection_NumProps, $dataSection, 0x5, 0x1e);
        $this->writeSummaryProp($props->getDescription(), $dataSection_NumProps, $dataSection, 0x6, 0x1e);
        $this->writeSummaryProp($props->getLastModifiedBy(), $dataSection_NumProps, $dataSection, 0x8, 0x1e);
        $this->writeSummaryPropOle($props->getCreated(), $dataSection_NumProps, $dataSection, 0xc, 0x40);
        $this->writeSummaryPropOle($props->getModified(), $dataSection_NumProps, $dataSection, 0xd, 0x40);
        //    Security
        $dataSection[] = [
