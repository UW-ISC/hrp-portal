...
namespace WPDT\PhpOffice\PhpSpreadsheet\Writer\Pdf;

use WPDT\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Html;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Pdf;
class Mpdf extends Pdf
{
    /** @var bool */
    protected $isMPdf = \true;
    /**
    ...
    {
        return new \WPDT\Mpdf\Mpdf($config);
    }
    /**
