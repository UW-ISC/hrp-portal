...
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder;
use WPDT\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellFill;
...
class Xf
{
    ...
    public function writeXf()
    {
        ...
        $atr_bdr = CellBorder::style($this->style->getBorders()->getBottom()) || CellBorder::style($this->style->getBorders()->getTop()) || CellBorder::style($this->style->getBorders()->getLeft()) || CellBorder::style($this->style->getBorders()->getRight()) ? 1 : 0;
        ...
        $atr_prot = self::mapLocked($this->style->getProtection()->getLocked()) | self::mapHidden($this->style->getProtection()->getHidden());
        ...
        $border1 = CellBorder::style($this->style->getBorders()->getLeft());
        ...
        $diag_tl_to_rb = $diagonalDirection == Borders::DIAGONAL_BOTH || $diagonalDirection == Borders::DIAGONAL_DOWN;
        $diag_tr_to_lb = $diagonalDirection == Borders::DIAGONAL_BOTH || $diagonalDirection == Borders::DIAGONAL_UP;
