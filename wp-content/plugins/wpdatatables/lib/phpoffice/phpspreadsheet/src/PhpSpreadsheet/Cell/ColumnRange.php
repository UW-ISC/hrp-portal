...
class ColumnRange implements AddressRange
{
    ...
    {
        $this->validateFromTo(Coordinate::columnIndexFromString($from), Coordinate::columnIndexFromString($to ?? $from));
    ...
    {
        \array_walk($array, function (&$column) : void {
    ...
    {
        return new CellRange(CellAddress::fromColumnAndRow($this->from, 1, $this->worksheet), CellAddress::fromColumnAndRow($this->to, AddressRange::MAX_ROW));
    }
