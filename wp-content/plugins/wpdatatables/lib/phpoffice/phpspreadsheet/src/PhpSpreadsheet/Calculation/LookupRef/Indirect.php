...
class Indirect
{
    ...
    public static function INDIRECT($cellAddress, $a1fmt, Cell $cell)
    {
        ...
        if (!\preg_match('/^' . Calculation::CALCULATION_REGEXP_CELLREF . '$/miu', $cellAddress1, $matches) || $cellAddress2 !== null && !\preg_match('/^' . Calculation::CALCULATION_REGEXP_CELLREF . '$/miu', $cellAddress2, $matches)) {
            return ExcelError::REF();
        }
