...
class Graph
{
     ...
     * @return null
     */
    public static function graph($eq, $xLow, $xHigh, $xStep = null, $xyGrid = \false, $yGuess = \true, $yLow = null, $yHigh = null)
    {
        ...
        if ($xLow > $xHigh) {
            list($xLow, $xHigh) = array($xHigh, $xLow);
        }
        //swap function
        //Smart xStep calc
        if ($xStep == \false) {
