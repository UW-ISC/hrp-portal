...
$metaData = array('Author' => 'Mark Baker <mark@lange.demon.co.uk>', 'Description' => 'PHP Class for working with Matrix numbers', 'Copyright' => 'Mark Baker (c) 2013-' . \date('Y'), 'Timestamp' => \time(), 'Version' => '0.1.0', 'Date' => \date('Y-m-d'));
// cleanup
