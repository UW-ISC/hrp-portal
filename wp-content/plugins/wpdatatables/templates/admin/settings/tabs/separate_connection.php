    ...
    <div class="row">
        <div class="separate-conn-not-available-notice" style="max-width: 1440px;margin: 0 auto;padding: 10px;text-align: center;">
            ...
            <button class="btn btn-primary wdt-upgrade-btn m-b-20">
                <a rel="nofollow" target="_blank" href="https://wpdatatables.com/pricing/?utm_source=wpdt-admin&medium=separate-connection&campaign=separate-connection-upgrade"> <?php esc_html_e('Upgrade', 'wpdatatables'); ?></a>
            </button>
