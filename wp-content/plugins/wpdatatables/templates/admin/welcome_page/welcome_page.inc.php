...
<div class="wrap wdt-datatables-admin-wrap">
                    ...
                    <div class="wdt-welcome-header">
                        <div class="row m-0">
                            ...
                            <div class="col-sm-6 text-center wdt-welcome-message">
                                ...
                                <p>
                                    <?php esc_html_e('wpDataTables is the best-selling WordPress table plugin which makes your work with tables, charts and data management easy. 80,000+ companies and individuals already trust wpDataTables', 'wpdatatables'); ?>
                                </p>
    ...
    <div class="row">
        <h6 class="text-center wdt-footer-title">
            ...
            <a href="<?php echo WDT_COMPANY_URL; ?>/?utm_source=full&utm_medium=plugin&utm_campaign=wpdtful" target="_blank">
