...
<div class="wdt-mysql-query-notice-block hidden">
    ...
    <div class="col-sm-6  notice-images">
        <div class="wpdt-custom-center-flex" style="align-items: center;">
            <img style="height: 500px;margin-right: 10px; width: 99%;" src="<?php echo WDT_ASSETS_PATH ?>img/feature-preview-notice/starter/mysql-query.gif" alt="SQL query image notice"/>
        </div>
    </div>
</div>
