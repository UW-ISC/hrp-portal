...
<div class="row wpdt-flex wdt-third-row">
        ...
        <div class="card wdt-premium-feature" data-value="mysql" data-toggle="html-premium-popover"  data-placement="top" title="title" data-content="content">
            ...
            <div class="card-body p-b-20 p-r-20 p-t-20">
                <h4 class="m-t-0 m-b-8 f-14">
                    <span class="opacity-6 f-14"><?php esc_html_e('Generate a query to the MySQL database', 'wpdatatables'); ?>.</span>
                    <i class="wpdt-icon-star-full" style="color: #091D70;"></i>
                    <span class="f-14" style="opacity:1 !important;font-weight: bold; color: #091D70;"><?php esc_html_e('Available from Standard Licence', 'wpdatatables'); ?>.</span>
                </h4>
    ...
    <div class="wdt-constructor-type-selecter-block col-sm-6">
        <div class="card wdt-premium-feature" data-value="wp" data-toggle="html-premium-popover"  data-placement="top" title="title" data-content="content">
            ...
            <div class="card-body p-b-20 p-r-20 p-t-20">
                <h4 class="m-t-0 m-b-8 f-14">
                    <span class="opacity-6 f-14"><?php esc_html_e('Generate a query to the WordPress database', 'wpdatatables'); ?>.</span>
                    <i class="wpdt-icon-star-full" style="color: #091D70;"></i>
                    <span class="f-14" style="opacity:1 !important;font-weight: bold; color: #091D70;"><?php esc_html_e('Available from Standard Licence', 'wpdatatables'); ?>.</span>
                </h4>
