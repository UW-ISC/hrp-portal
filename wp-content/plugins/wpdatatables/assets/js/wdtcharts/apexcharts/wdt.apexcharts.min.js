...
this.options.xaxis.title.position="bottom";if(!(['pie','donut','radialBar','radar','bar'].includes(this.options.chart.type))||Array.isArray(this.options.yaxis)||chartConfig.type==='apexcharts_column_chart'||chartConfig.type==='apexcharts_stacked_column_chart'||chartConfig.type==='apexcharts_100_stacked_column_chart'){this.setSeriesOptions(chartConfig);this.setMultiYaxisOptions(chartConfig)}else if(this.options.chart.type==='bar'||this.options.chart.type==='radar')
