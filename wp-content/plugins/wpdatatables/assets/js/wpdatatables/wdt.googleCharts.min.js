...
this.chart.draw(this.googleDataTable,this.options)}},refresh:function(){if(typeof google.visualization!=='undefined'&&typeof google.visualization.DataTable!=='undefined'&&this.chart!=null){this.googleDataTable=new google.visualization.DataTable();for(var i in this.columns){this.googleDataTable.addColumn(this.columns[i])}
