...
(function (factory) {
    ...
    var FixedHeader = function (dt, config) {
        ...
        this.wpDatatableDescription =
            JSON.parse(
                jQuery('#' + $(dt.table().header())
                    .closest('table')
                    .data('described-by'))
                    .val()
            );
    ...
    $.extend(FixedHeader.prototype, {
        ...
        //                     var potential = +right.replace(/px/g, '');
        //                     $(this).css('right', potential > 0 ? potential : 0);
        //                 }
        //                 else if(left !== 'auto' && rtl) {
        //                     var potential = +left.replace(/px/g, '');
        ...
        _scroll: function (forceChange) {
            ...
            if (this.c.header) {
                ...
                else if (!position.visible || windowTop + this.c.headerOffset <= bodyTop) {
                    headerMode = 'in-place';
                }
            ...
            if (this.s.dt.settings()[0]._fixedColumns !== undefined) {
                if (this.s.dt.settings()[0]._fixedColumns.c.left !== 0 || this.s.dt.settings()[0]._fixedColumns.c.right !== 0) {
                    this.s.dt.settings()[0]._fixedColumns.left(this.s.dt.settings()[0]._fixedColumns.c.left);
                    this.s.dt.settings()[0]._fixedColumns.right(this.s.dt.settings()[0]._fixedColumns.c.right);
                }
