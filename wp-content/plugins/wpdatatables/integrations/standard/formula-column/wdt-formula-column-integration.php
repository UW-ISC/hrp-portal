...
class FormulaColumn
{
    public static function init()
    {
        ...
        add_filter('wpdatatables_column_formatter_file_name', array('WDTIntegration\FormulaColumn', 'columnFormatterFileName'), 10, 2);
        ...
        add_action('wpdatatables_add_custom_column_type_option', array('WDTIntegration\FormulaColumn', 'addFormulaColumnType'));
