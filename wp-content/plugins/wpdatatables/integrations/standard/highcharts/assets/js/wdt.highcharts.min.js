...
let chartID=this.container.replace(/.*_(\d+)/,'$1');if(jQuery(this.container).parent().find('.wdt-wrapper-chart-loader').length!=0){jQuery(this.container).parent().find('.wdt-wrapper-chart-loader').each(function(){if(jQuery(this).attr('data-id')===chartID){jQuery(this).hide()}})}
this.chart=new Highcharts.Chart(this.options)},clearSeriesTypeOverrides:function(){if(!Array.isArray(this.options.series)){return}
for(let i=0;i<this.options.series.length;i++){if(this.options.series[i]&&this.options.series[i].type){delete this.options.series[i].type}}},setType:function(type){this.chartType=type;switch(type){case 'highcharts_basic_area_chart':this.options.chart.type='area';break;case 'highcharts_funnel3d_chart':this.options.chart.type='funnel3d';this.options.chart.options3d={enabled:!0,alpha:10,depth:50,viewDistance:50};this.options.plotOptions={series:{dataLabels:{enabled:!0,format:'<b>{point.name}</b> ({point.y:,.0f})',y:10,},neckWidth:'30%',neckHeight:'25%',width:'70%',height:'70%'},};this.options.legend={enabled:!1};break;case 'highcharts_funnel_chart':this.options.chart.type='funnel';this.options.plotOptions={series:{dataLabels:{enabled:!0,format:'<b>{point.name}</b> ({point.y:,.0f})',color:(Highcharts.theme&&Highcharts.theme.contrastTextColor)||'black',softConnector:!0},neckWidth:'30%',neckHeight:'25%',width:'55%'},funnel:{name:'<b>{point.name}</b> ({point.y:,.2f})'}};this.options.legend={enabled:!1};break;case 'highcharts_bubble_chart':case 'highcharts_sized_bubble_chart':this.options.chart.type='bubble';this.clearSeriesTypeOverrides();break;case 'highcharts_bubble3d_chart':case 'highcharts_sized_bubble3d_chart':this.options.chart.type='bubble';this.clearSeriesTypeOverrides();break;case 'highcharts_stacked_area_chart':this.options.chart.type='area';this.options.plotOptions={area:{stacking:'normal'}};break;case 'highcharts_basic_bar_chart':this.options.chart.type='bar';break;case 'highcharts_scatter_plot':this.options.chart.type='scatter';break;case 'highcharts_stacked_bar_chart':this.options.chart.type='bar';this.options.plotOptions={series:{stacking:'normal'}};break;case 'highcharts_basic_column_chart':this.options.chart.type='column';this.options.tooltip.useHTML=!0;break;case 'highcharts_3d_column_chart':this.options.chart.type='column';this.options.chart.margin=75;this.options.chart.options3d={enabled:!0,alpha:15,beta:15,viewDistance:25,depth:40};this.options.plotOptions={column:{depth:25}};this.options.tooltip.useHTML=!0;break;case 'highcharts_stacked_column_chart':this.options.tooltip.useHTML=!0;this.options.chart.type='column';this.options.plotOptions={column:{stacking:'normal'}};break;case 'highcharts_pie_chart':this.options.chart.type='pie';this.options.plotOptions={pie:{allowPointSelect:!0,cursor:'pointer',dataLabels:{enabled:!0,format:'<b>{point.name}</b>: {point.percentage:.1f} %',style:{color:(Highcharts.theme&&Highcharts.theme.contrastTextColor)||'black'}}}};this.options.tooltip.pointFormat='{series.name}: <b>{point.percentage:.1f}%</b>'
...
j++}}}else if(chartConfig.type=='highcharts_bubble3d_chart'||chartConfig.type=='highcharts_sized_bubble3d_chart'){for(let i in this.options.series){if(!this.options.series[i]){continue}
let rgbColor=this.hexToRgb(this.options.series[i].color);if(!rgbColor){continue}
if(!this.options.series[i].marker){this.options.series[i].marker={}}
if(!this.options.series[i].marker.fillColor){this.options.series[i].marker.fillColor={radialGradient:{cx:0.4,cy:0.3,r:0.7}}}
this.options.series[i].marker.fillColor.stops=[[0,"rgba(255,255,255,0.5)"],[1,"rgba("+rgbColor.r+","+rgbColor.g+","+rgbColor.b+",0.5)"]]}}},setChartConfig:function(chartConfig){if(chartConfig.type){this.chartType=chartConfig.type}
this.setWidth(chartConfig.width);chartConfig.height?this.options.chart.height=chartConfig.height:null;this.options.chart.backgroundColor=chartConfig.background_color;chartConfig.border_width?this.options.chart.borderWidth=chartConfig.border_width:null;this.options.chart.borderColor=chartConfig.border_color;chartConfig.border_radius?this.options.chart.borderRadius=chartConfig.border_radius:null;chartConfig.zoom_type?this.options.chart.zoomType=chartConfig.zoom_type:null;chartConfig.panning?this.options.chart.panning=chartConfig.panning:null;chartConfig.pan_key?this.options.chart.panKey=chartConfig.pan_key:null;this.options.chart.plotBackgroundColor=chartConfig.plot_background_color;this.options.chart.plotBackgroundImage=chartConfig.plot_background_image;chartConfig.plot_border_width?this.options.chart.plotBorderWidth=chartConfig.plot_border_width:null;this.options.chart.plotBorderColor=chartConfig.plot_border_color;if(this.options.chart.type!='pie'){let j=0;Array.isArray(this.options.yAxis)?this.options.yAxis.splice(1):'';for(let i in chartConfig.series_data){this.options.series[j].name=chartConfig.series_data[i].label;this.options.series[j].color=chartConfig.series_data[i].color;if(chartConfig.series_data[i].type)
...
delete this.options.series[j].yAxis}}
j++}
if(chartConfig.type==='highcharts_bubble3d_chart'||chartConfig.type==='highcharts_sized_bubble3d_chart'){for(let i in this.options.series){if(!this.options.series[i]){continue}
let rgbColor=this.hexToRgb(this.options.series[i].color);if(!rgbColor){continue}
if(!this.options.series[i].marker){this.options.series[i].marker={}}
if(!this.options.series[i].marker.fillColor){this.options.series[i].marker.fillColor={radialGradient:{cx:0.4,cy:0.3,r:0.7}}}
this.options.series[i].marker.fillColor.stops=[[0,"rgba(255,255,255,0.5)"],[1,"rgba("+rgbColor.r+","+rgbColor.g+","+rgbColor.b+",0.5)"]]}}}
...
this.numberFormat=JSON.parse(jQuery('#'+this.connectedWPDataTable.data('described-by')).val()).number_format;this.connectedWPDataTable.fnSettings().aoDrawCallback.push({sName:'chart_filter_follow',fn:function(oSettings){obj.options.xAxis.categories=[];let seriesIndex=0;let filteredData=obj.connectedWPDataTable._('tr',{"filter":"applied"}).toArray();if(obj.options.chart.type==='bubble'){obj.options.series.forEach(function(series){series.data=[]});if(!obj.options.series.length){return}
let decimalSep=obj.numberFormat==1?'.':',';let thousandSep=obj.numberFormat==1?',':'.';let isSizedBubble=obj.chartType==='highcharts_sized_bubble_chart'||obj.chartType==='highcharts_sized_bubble3d_chart';for(let rowIndex in filteredData){let row=filteredData[rowIndex];let selectedColumns=obj.columnIndexes.length?obj.columnIndexes.map(function(index){return row[index]}):row;if(!selectedColumns||selectedColumns.length<2){continue}
let firstValueAsNumber=parseFloat(wdtUnformatNumber(selectedColumns[0],decimalSep,thousandSep,!0));let hasPointName=isNaN(firstValueAsNumber);let seriesStartIndex=hasPointName?1:0;if(isSizedBubble){for(let columnIndex=seriesStartIndex;columnIndex<selectedColumns.length;columnIndex+=2){let seriesPosition=Math.floor((columnIndex-seriesStartIndex)/2);if(!obj.options.series[seriesPosition]){break}
let y=parseFloat(wdtUnformatNumber(selectedColumns[columnIndex],decimalSep,thousandSep,!0));if(isNaN(y)){continue}
let zRaw=typeof selectedColumns[columnIndex+1]!=='undefined'?selectedColumns[columnIndex+1]:10;let z=parseFloat(wdtUnformatNumber(zRaw,decimalSep,thousandSep,!0));if(isNaN(z)){z=10}
let x=parseFloat(rowIndex);if(hasPointName){obj.options.series[seriesPosition].data.push({name:selectedColumns[0],x:x,y:y,z:z})}else{obj.options.series[seriesPosition].data.push([x,y,z])}}}else{for(let columnIndex=seriesStartIndex;columnIndex<selectedColumns.length;columnIndex++){let seriesPosition=columnIndex-seriesStartIndex;if(!obj.options.series[seriesPosition]){break}
let y=parseFloat(wdtUnformatNumber(selectedColumns[columnIndex],decimalSep,thousandSep,!0));if(isNaN(y)){continue}
let x=parseFloat(rowIndex);if(hasPointName){obj.options.series[seriesPosition].data.push({name:selectedColumns[0],x:x,y:y,z:10})}else{obj.options.series[seriesPosition].data.push([x,y,10])}}}}}else{for(let j in obj.columnIndexes){let seriesDataEntry=[];if((obj.columnIndexes.length>0)&&(j==0)){for(let i in filteredData){obj.options.xAxis.categories.push(filteredData[i][obj.columnIndexes[j]])}}else{for(let i in filteredData){let entry=filteredData[i][obj.columnIndexes[j]];if(obj.options.chart.type=='pie'){if(obj.numberFormat==1){seriesDataEntry.push({name:obj.options.xAxis.categories[i],y:parseFloat(wdtUnformatNumber(entry,'.',',',!0))})}else{seriesDataEntry.push({name:obj.options.xAxis.categories[i],y:parseFloat(wdtUnformatNumber(entry,',','.',!0))})}}else if(obj.options.chart.type=='treemap'){if(obj.numberFormat==1){seriesDataEntry.push({colorValue:parseFloat(wdtUnformatNumber(entry,'.',',',!0)),name:obj.options.xAxis.categories[i],value:parseFloat(wdtUnformatNumber(entry,'.',',',!0))})}else{seriesDataEntry.push({colorValue:parseFloat(wdtUnformatNumber(entry,',','.',!0)),name:obj.options.xAxis.categories[i],value:parseFloat(wdtUnformatNumber(entry,',','.',!0))})}}else{if(obj.numberFormat==1){seriesDataEntry.push({name:obj.options.xAxis.categories[i],y:parseFloat(wdtUnformatNumber(entry,'.',',',!0))})}else{seriesDataEntry.push({name:obj.options.xAxis.categories[i],y:parseFloat(wdtUnformatNumber(entry,',','.',!0))})}}}
if(obj.group_chart==1){let output=[];for(let i in seriesDataEntry){if(typeof output!=='undefined'&&output.length>0){let value_key='none';for(let j in output){if(value_key==='none'){if(output[j].name==seriesDataEntry[i].name){value_key=j}}}
if(value_key==='none'){output.push(seriesDataEntry[i])}else{for(let n in seriesDataEntry[i]){if(n!='name'){output[value_key][n]+=seriesDataEntry[i][n]}}}}else{output.push(seriesDataEntry[i])}}
...
obj.chart=new Highcharts.Chart(obj.options);let chartID=obj.container.replace(/.*_(\d+)/,'$1');if(jQuery(obj.container).parent().find('.wdt-wrapper-chart-loader').length!=0){jQuery(obj.container).parent().find('.wdt-wrapper-chart-loader').each(function(){if(jQuery(this).attr('data-id')===chartID){jQuery(this).hide()}})}
Highcharts.setOptions({lang:{decimalPoint:obj.getNumberFormat()===1?',':'.',thousandsSep:obj.getNumberFormat()===1?'.':','}})}})},hexToRgb:function(hex){let result=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hex);return result?{r:parseInt(result[1],16),g:parseInt(result[2],16),b:parseInt(result[3],16)}:null}};return obj}