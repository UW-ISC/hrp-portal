...
<script type="text/javascript">
    ...
    var wdtPostMetaByPostTypes = <?php echo WDTSQLConstructor::wdtGetPostMetaKeysForPostTypes() ?>;
    var wdtTaxonomiesByPostTypes = <?php echo WDTSQLConstructor::wdtGetTaxonomiesForPostTypes() ?>;
</script>
