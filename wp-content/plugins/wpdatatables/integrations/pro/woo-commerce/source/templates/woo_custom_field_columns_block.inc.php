<script id="wdt-woo-commerce-cf-template" type="text/x-jsrender">
    <div class="card-body bg-white wdt-woo-commerce-cf-template">
        <div class="row ">
    ...
    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
       title="<?php esc_attr_e('Enter the header', 'wpdatatables'); ?>"></i>
            ...
            <div class="fg-line form-group m-b-0">
                <input id="wdt-woo-commerce-cf-header-{{>cfColumnId}}" data-count="{{>cfColumnId}}" type="text"
                       class="form-control input-sm wdt_woo_commerce_cf_parameter" data-value="column_header"
    ...
    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
       title="<?php esc_attr_e('Specify the name of the custom field', 'wpdatatables'); ?>"></i>
            ...
            <div class="fg-line form-group m-b-0">
                <input id="wdt-woo-commerce-cf-{{>cfColumnId}}" data-count={{>cfColumnId}} type="text"
                       class="form-control input-sm wdt_woo_commerce_cf_parameter" data-value="cf"
                       placeholder="<?php esc_attr_e('Custom Field', 'wpdatatables'); ?>">
            </div>
        </div>
            <div class="col-sm-1 p-r-0 p-l-0 text-center">
                <ul class="actions p-r-5">
                    <li class="p-t-30" id="wdt-constructor-delete-woo-cf-column">
                        <a>
