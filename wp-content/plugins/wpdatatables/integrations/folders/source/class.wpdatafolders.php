...
class WPDataFolders
{
    ...
    {
        ob_start();
        include_once WDT_INTEGRATIONS_PATH . 'folders/templates/browse_table_insert_card.inc.php';
    ...
    public function enqueueScript()
    {
        ...
        if (!$instance) return;
        wp_enqueue_script('wpdt-folders-jstree-js', WDT_INTEGRATIONS_URL . 'folders/assets/js/jstree.min.js', array('jquery'), WDT_CURRENT_VERSION, true);
        wp_enqueue_script('wpdt-overlayscroll-js', WDT_INTEGRATIONS_URL . 'folders/assets/js/overlayscrollbars.min.js', array('jquery'), WDT_CURRENT_VERSION, true);
        wp_enqueue_script('wpdt-custom-folders-js', WDT_INTEGRATIONS_URL . 'folders/assets/js/wpdt-folders.min.js', array('jquery'), WDT_CURRENT_VERSION, true);

        wp_enqueue_style('wdt-wpdt-icons', WDT_ROOT_URL . 'assets/css/style.min.css', array(), WDT_CURRENT_VERSION);
        wp_enqueue_style('wpdt-folders-jstree-css', WDT_INTEGRATIONS_URL . 'folders/assets/css/jstree.css', array(), WDT_CURRENT_VERSION);
        wp_enqueue_style('wpdt-custom-folders-css', WDT_INTEGRATIONS_URL . 'folders/assets/css/wpdt-folders.css', array(), WDT_CURRENT_VERSION);
        wp_enqueue_style('wpdt-overlayscrollbars-css', WDT_INTEGRATIONS_URL . 'folders/assets/css/overlayscrollbars.css', array(), WDT_CURRENT_VERSION);
