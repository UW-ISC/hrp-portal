<?php
/**
 * Divi 5 server-side module: wpDataTable.
 *
...
/**
 * Class Divi_Wpdt_D5_WpDataTable_Module
 */
class Divi_Wpdt_D5_WpDataTable_Module implements \ET\Builder\Framework\DependencyManagement\Interfaces\DependencyInterface {
	...
	public static function register_module() {
		$module_json_folder_path = dirname( __DIR__, 2 ) . '/visual-builder/src/wpdatatable';
	...
	public static function render_callback( $attrs, $content, $block, $elements ) {
		...
		$props = Divi_Wpdt_Shortcode_Helper::flatten_wpdatatable_attrs_for_render( is_array( $attrs ) ? $attrs : array() );
		$inner = Divi_Wpdt_Shortcode_Helper::render_wpdatatable_from_props( $props );
		...
		return Module::render(
			array(
				...
				'moduleClassName'     => 'divi_wpdt_wpdatatable',
