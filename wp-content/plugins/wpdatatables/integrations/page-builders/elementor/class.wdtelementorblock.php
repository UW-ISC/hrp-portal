...
final class WPDataTables_Elementor_Widgets {
    ...
    {
        require_once(WDT_INTEGRATIONS_PATH . 'page-builders/elementor/widgets/class.wpDataTablesElementorWidget.php');
        require_once(WDT_INTEGRATIONS_PATH . 'page-builders/elementor/widgets/class.wpDataChartsElementorWidget.php');
    }
    ...
    {
        wp_register_style('wpdt-elementor-widget-font', WDT_INTEGRATIONS_URL . 'page-builders/elementor/css/style.css', array(), WDT_CURRENT_VERSION);
