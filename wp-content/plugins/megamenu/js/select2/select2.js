...
/*
 * -----------------------------------------------------------------------------
 * Modified for distribution in the Max Mega Menu WordPress plugin. This file is
 * not identical to the upstream Select2 3.5.4 release: it uses the unminified
 * source and includes compatibility changes for jQuery 3.x / jQuery Migrate
 * (e.g. avoiding deprecated helpers and event shorthands). The original
 * copyright and license above remain in effect.
 * -----------------------------------------------------------------------------
 */
(function ($) {
    if(typeof $.fn.each2 == "undefined") {
        $.extend($.fn, {
            ...
            * use it carefully, as it reuses one jQuery collection and sets j[0] each iteration
            */
            each2 : function (c) {
...
(function ($, undefined) {
    ...
    function syncCssClasses(dest, src, adapter) {
        ...
        classes = trimS2(dest.attr("class"));
    ...
    AbstractSelect2 = clazz(Object, {
                ...
                if (!("query" in opts)) {
                    if ("ajax" in opts) {
                        ...
                        if (opts.createSearchChoice === undefined) {
                            opts.createSearchChoice = function (term) { return {id: trimS2(term), text: trimS2(term)}; };
                        }
        ...
        getPlaceholderOption: function() {
            if (this.select) {
                ...
                } else if (trimS2(firstOption.text()) === "" && firstOption.val() === "") {
