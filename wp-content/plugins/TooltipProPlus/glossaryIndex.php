    ...
    public static function outputGlossaryIndexPage( $shortcodeAtts ) {
        ...
        if ( $glossary_index ) {
            ...
            foreach ( $glossary_index as $glossaryItem ) {
                ...
                if ( get_option( 'cmtt_showFeaturedImageThumbnail', FALSE ) && in_array( $glossaryIndexStyle, array( 'image-tiles-view' ) ) ) {
                ...
                $preItemTitleContent .= '<' . $tag . ' class="' . $glossary_list_class . ' ' . $additionalClass . '" ' . $href . ' ' . $windowTarget . ' ';
