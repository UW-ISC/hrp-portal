jQuery(document).ready(function($) {
	...
	$('#add_redirect').click(function(e) {
		redirect_row_index++;
		$(".redirect_table_row:last").clone(true).attr("id", "row_" + redirect_row_index).insertAfter(".redirect_table_row:last");
	...
	$("a.copy").click(function(e) {
		e.preventDefault();
		redirect_row_index++;
		$(this).closest('tr').clone(true).attr("id", "row_" + redirect_row_index).insertAfter(".redirect_table_row:last");
