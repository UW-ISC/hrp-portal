  ...
  <div id="informationStory" class="span-11 append-1">
	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div class="contentdate">
			...
			<p class="authoring">Posted under <?php the_category(', ') ?> by <a href="mailto:<?php the_author_email(); ?>"><?php the_author_firstname(); ?> <?php the_author_lastname(); ?></a>&nbsp;<?php edit_post_link('(Edit Post)', '', ''); ?></p>
