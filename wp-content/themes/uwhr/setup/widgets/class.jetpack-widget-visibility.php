 ...
 *
 * Taken from WordPress.com's JetPack
 */
...
class Jetpack_Widget_Conditions {
	...
	public static function widget_admin_setup() {
		wp_enqueue_style( 'widget-conditions', get_template_directory_uri() . '/assets/admin/widget-conditions/widget-conditions.css' );
		wp_enqueue_script( 'widget-conditions', get_template_directory_uri() . '/assets/admin/widget-conditions/widget-conditions.js', array( 'jquery', 'jquery-ui-core' ), 20140721, true );
	}
